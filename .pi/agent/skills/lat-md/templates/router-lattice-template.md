...
<Explain why this root lattice exists and what it should not duplicate from nested lattices.>

## <Nested lattice or subtree name>
...
<Add real root sections for any root-level file that carries an `@lat:` anchor.>
