...
Use Codex CLI as a local review helper. This is for critical second-opinion review of code, plans, specs, diffs, and implementation slices. The reviewer agent can run for a long time (more than ten minutes if the code is large.) Default to 3600 seconds timeout.
