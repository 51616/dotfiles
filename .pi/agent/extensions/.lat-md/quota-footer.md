...
The footer label is `5h [█████]100% · weekly [█████]100%` with no leading `q` prefix. The bars use fractional Unicode blocks and stay fixed-width so the footer can reserve a stable right-aligned slot.
