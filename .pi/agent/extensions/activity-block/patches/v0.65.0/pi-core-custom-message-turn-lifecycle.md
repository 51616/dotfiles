# pi core patch note (v0.65.0): custom-message triggerTurn lifecycle
...
From `~/research/pi-mono/packages/coding-agent` (after applying both v0.65.0 patches):
